                                    ...
                                    <div class="rex-featured">
                                        <div class="col-md-12">
                                            <div class="display-flax featured-box">
                                                <div class="col-md-6">
                                                    <img class="img-responsive" src="http://placehold.it/502x276" alt="">
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="rex-featured-description">
                                                        ...
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora
                                                            itaque cum quaerat facere est commodi delectus dicta impedit
                                                            ipsum vero quod quo eligendi, blanditiis quia alias tenetur neque
                                                            nesciunt, totam?</p>
                                                        <p>On the other hand, we denounce with righteous indignation and dislike
                                                            men wh are so beguiled and demoralized by the charms of pleasure
                                ...
                                <div class="row rex-portfolios" role="tabpanel" id="rex-portfolios">
                                    ...
                                    <figure class="identity col-lg-4 col-sm-6 rex-portfolio-item">
                                        ...
                                        <figcaption class="rex-featured-description">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora itaque cum
                                                quaerat facere est commodi delectus dicta impedit ipsum vero quod quo eligendi,
                                                blanditiis quia alias tenetur neque nesciunt, totam?</p>
                                        </figcaption>
                                    </figure>
