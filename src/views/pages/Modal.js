...
export default class Modal extends Component {
  ...
  render() {
    ...
    const styles = {
      ...
      modalContainer: {
        display: hashHistory.getCurrentLocation().pathname.includes("post")
          ? "block"
          : "none"
      }
    };
    if (hashHistory.getCurrentLocation().pathname.includes("post")) {
      return (
        <div
          className={
            hashHistory.getCurrentLocation().pathname.includes("post") ? (
